...
const Header = () => {
  return (
    <Head>
      ...
      <meta name="title" property="og:title" content={CONSTANTS.DEFAULT_TITLE} />
      <meta name="description" property="og:description" content={CONSTANTS.DEFAULT_DESCRIPTION} />
      ...
      <meta property="twitter:title" content={CONSTANTS.DEFAULT_TWITTER_TITLE} />
      <meta property="twitter:description" content={CONSTANTS.DEFAULT_TWITTER_DESCRIPTION} />
